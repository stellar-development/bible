...
<html>
	<head>
		...
		<form method="POST" action="verse.php">
			...
			<select name="book" required>
				<optgroup label="Old Testament">
					...
					<option value="deuteronomy">Deuternomy</option>
		...
		<br>
		<p>If you would like for more than one Bible verse to be displayed, you may enter a range into the input box using the format <strong>CHAPTER:START-END</strong>. If you would like for all the verses of a chapter to be displayed, just enter the chapter into the input box using the format <strong>CHAPTER</strong>.</p>
	</body>
</html>